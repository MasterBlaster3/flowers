...
const zoneFlowers = () => {
    const filteredFlowers = []  // Do not modify
    const threeFlowers = []
    //makes additional array to push all of the flowers in zone 3 to
    // for (const flower of flowers){
    //     for (const zone of flower.usdaZones) {
    //         if (zone === 3){threeFlowers.push(flower)}
    //     }
    // }
...
const orangeFlowers = () => {
    ...
    //iterates through flower array->the colors array and pushes the flower into filteredflowers if it finds orange
